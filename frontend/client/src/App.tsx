...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/booking/:workspaceId" component={UniversalBookingPage} />
  ...
  <Route path="/dashboard/expenditures" component={ExpendituresPage} />
  <Route path="/dashboard/staff-kpi" component={StaffKPIPage} />
  <Route path="/dashboard/vendor-management" component={VendorManagementPage} />
  ...
  <Route path="/dashboard/memberships" component={MembershipsPage} />
